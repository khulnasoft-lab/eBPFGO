...
func main() {
	...
	var programs = []struct {
		name      string
		direction ebpfgo.TcFlowDirection
	}{
		{*ingressFunction, ebpfgo.TcDirectionIngress},
		{*egressFunction, ebpfgo.TcDirectionEgress},
	}
	for _, prog := range programs {
		...
		attachParams := &ebpfgo.TcAttachParams{
			Interface:      *iface,
...
func printBpfInfo(bpf ebpfgo.System) {
	fmt.Println("Maps:")
